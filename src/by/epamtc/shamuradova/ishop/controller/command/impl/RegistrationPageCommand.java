...
/**
 * Класс-комманда, который передает управление странице registration.jsp 
 * 
 * The command class that transfers control to the registration.jsp page
 * 
...
public class RegistrationPageCommand implements Command {
	...
	private static final String NAME_CURRENT_COMMAND = "controller?command=REGISTRATION_PAGE";
	private static final String NAME_CURRENT_PAGE = "/WEB-INF/jsp/registration.jsp";
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher(NAME_CURRENT_PAGE);
