...
/**
 *Класс реализующий интерфейс SignInDAO для проверки данных пользователя в базе данных и авторизации пользователя
 * 
 * Class for checking user data in database and signing in user
 * 
 * @author Шамурадова Виктория 2020
 */
public class SQLSignInDAOImpl2 implements SignInDAO {
	
	
	private ResultSetHandler2<User> resultSetHandlerUser;
	private ConnectionPool pool;
	
	public SQLSignInDAOImpl2() {
